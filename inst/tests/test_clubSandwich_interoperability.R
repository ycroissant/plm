...
## test of detection of those vcovs and test of translation function plm:::trans_clubSandwich_vcov
# library(plm)
# 
# 
# clubSandwich.avail <- if(!requireNamespace("clubSandwich", quietly = TRUE)) FALSE else TRUE
# 
# if(clubSandwich.avail) {
...
# 
# 	clubSandwich::coef_test(plm_unweighted, vcov = "CR1", cluster = "individual", test = "naive-t")
# 	clubSandwich::coef_test(plm_unweighted, vcov = "CR1", cluster = "individual", test = "Satterthwaite")
# 
# 
# 	vcov_club_id   <- clubSandwich::vcovCR(plm_unweighted, type = "CR0", cluster = "individual")
# 	vcov_club_time <- clubSandwich::vcovCR(plm_unweighted, type = "CR0", cluster = "time")
...
# 	attr(plm:::trans_clubSandwich_vcov(vcov_club_id, attr(model.frame(plm_unweighted), "index")), "cluster")
# 
# 	vcov_club_id <- clubSandwich::vcovCR(plm_unweighted, type = "CR0", cluster = "individual") # get "fresh" vcov
# 
# 	# clubSandwich's Wald tests
# 	# clubSandwich::Wald_test(plm_unweighted, constraints = c("legal","beertaxa"), vcov = "CR1", test = "chi-sq")
# 	# clubSandwich::Wald_test(plm_unweighted, constraints = c("legal","beertaxa"), vcov = "CR0", test = "Naive-F")
# 	# clubSandwich::Wald_test(plm_unweighted, constraints = c("legal","beertaxa"), vcov = "CR0", test = "All")
# 
# 
...
# 	pwaldtest(plm_unweighted_re, vcov = clubSandwich::vcovCR(plm_unweighted, type = "CR2"), test = "F")
# 
