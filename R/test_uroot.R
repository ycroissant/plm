...
#' with a global (intersected) hypothesis. \insertCite{HANCK:13;textual}{plm} mentions it can
...
#' is not rejected by Hommel's procedure (\insertCite{HOMM:88;textual}{plm}) for family-wise
